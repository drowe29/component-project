...
For this assignment, I'll choose to builld upon the GameStatsTracker component. Some reasons I chose this one was because I really like to play videogames so there's personal interest and engagement in it. It could also be useful in the real world, as a lot of gamers like to track their stats and performance. It also demonstrates a variety of methods that add data, retrieve stats, and do calculations. Lastly, it's also the one that may be most achievable with the time constraints.
